  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2
          className="font-bold text-3xl mb-2 bg-gradient-to-r from-green-600 to-pink-600 bg-clip-text text-transparent"
        >
          📚 Edukasi Keuangan
        </h2>
        <p className="text-gray-600 text-sm">Belajar mengelola uang dengan cerdas dan menyenangkan!</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {topics.map((t, idx) => (
          ...
          >
            ...
            <div className="font-bold text-lg mb-2 text-gray-800">{t.title}</div>
            <div className="text-gray-700 leading-relaxed text-sm">{t.desc}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-lg border-2 border-blue-100">
          ...
          <h3 className="font-bold text-lg text-blue-800 mb-2">Tips Menabung</h3>
        ...
        <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg border-2 border-purple-100">
          <div className="text-3xl mb-3">🚀</div>
          <h3 className="font-bold text-lg text-purple-800 mb-2">Ilustrasi Sederhana</h3>
          <p className="text-sm text-gray-700 leading-relaxed">
            Bayangkan dompetmu seperti <strong className="text-purple-700">botol</strong>. 
            Jika kamu menuang terlalu banyak untuk jajan, botol cepat habis. 
            Kalau kamu <strong className="text-green-600">sisihkan sedikit setiap hari</strong>, 
      ...
      <div className="p-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl shadow-2xl text-white text-center">
        ...
        <p className="text-lg opacity-90">
          Menabung bukan soal berapa banyak yang kamu punya,<br/>
          tapi tentang <strong>konsistensi</strong> dan <strong>komitmen</strong> untuk mencapai impianmu!
        </p>
      </div>
    </div>
  );
